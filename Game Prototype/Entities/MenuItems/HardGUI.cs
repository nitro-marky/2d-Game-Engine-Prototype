...
{
    class HardGUI : GameEntity, IHoverObserver, IClickObserver, IRenderable
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                _renderComponent.Texture = ContentService.content.Load<Texture2D>("hard_menu_highlight");
            }
        ...
        public void NotifyClick(InputType type, int ID)
        {
            if (this._UID == ID)
            {
                Console.WriteLine("Clicked Hard");
            }
        }
